<form method="POST" action="{{ $action_url }}" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <div class="mb-3">
                ...
                @endif
                <div class="d-flex">
                    <div style="width: 200px" class="px-4">
                    ...
                    <div style="width: 200px" class="pe-4">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="exampleFormControlInput4" placeholder="" name="number"
                    value="{{ isset($product) ? $product->number : '' }}">
                @error('number')
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="exampleFormControlInput5" placeholder="%" name="sale"
                    value="{{ isset($product) ? $product->sale : '' }}">
                @error('sale')
            ...
            <div class="mb-3">
                ...
                <div class="border rounded">
                    <div id="imageWrapper" class="border-bottom d-flex" style="display: none;">
                        @foreach ($imgs ?? [] as $img)
                            <img src="{{ $img->path }}" alt="" class="m-3" width="120px"
                                height="120px">
                        @endforeach
                    </div>
    ...
    <script>
        ...
        provinceSelect.onchange = function() {
            ...
            var districts =
                {!! json_encode($districts) !!}; // Dữ liệu các quận/huyện, bạn cần đảm bảo dữ liệu này được truyền từ phía server
        ...
        districtSelect.onchange = function() {
            ...
            var wards =
                {!! json_encode($wards) !!}; // Dữ liệu các xã/phường, bạn cần đảm bảo dữ liệu này được truyền từ phía server
